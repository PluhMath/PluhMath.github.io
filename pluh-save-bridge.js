...
(function(global) {
  ...
  const GAME_INFO = {
    ...
    'run3': { id: 'run3', title: 'Run 3', prefixes: ['run3', 'run_3', 'run-3', 'run', 'openfl', 'so_', 'save', 'lastusername', 'player', 'run3_backup'], hasIndexedDB: false },
    'run-3': { id: 'run3', title: 'Run 3', prefixes: ['run3', 'run_3', 'run-3', 'run', 'openfl', 'so_', 'save', 'lastusername', 'player', 'run3_backup'], hasIndexedDB: false },
    'drift-boss': { id: 'drift-boss', title: 'Drift Boss', prefixes: ['drift', 'c2drift', 'c2_', 'driftboss', 'c2score'], hasIndexedDB: false },
    'driftboss': { id: 'drift-boss', title: 'Drift Boss', prefixes: ['drift', 'c2drift', 'c2_', 'driftboss', 'c2score'], hasIndexedDB: false },
    'tiny-fishing': { id: 'tiny-fishing', title: 'Tiny Fishing', prefixes: ['tiny', 'fish', 'tf_', 'upgrade', 'score', 'rod', 'depth', 'offline'], hasIndexedDB: false },
    'tinyfishing': { id: 'tiny-fishing', title: 'Tiny Fishing', prefixes: ['tiny', 'fish', 'tf_', 'upgrade', 'score', 'rod', 'depth', 'offline'], hasIndexedDB: false },
    'geometry-dash': { id: 'geometry-dash', title: 'Geometry Dash Subzero', prefixes: ['gd_', 'geometry', 'subzero', 'gd_save', 'gd_settings', 'geometrydash'], hasIndexedDB: false },
    'gd': { id: 'geometry-dash', title: 'Geometry Dash Subzero', prefixes: ['gd_', 'geometry', 'subzero', 'gd_save', 'gd_settings', 'geometrydash'], hasIndexedDB: false },
    'pluhshooter': { id: 'pluhshooter', title: 'PluhShooter.io', prefixes: ['pluhshooter', 'ps_', 'shooter'], hasIndexedDB: false },
    'pluhshooter-io': { id: 'pluhshooter', title: 'PluhShooter.io', prefixes: ['pluhshooter', 'ps_', 'shooter'], hasIndexedDB: false },
    'pluhus': { id: 'pluhus', title: 'PluhUs', prefixes: ['pluhus', 'among', 'impostor'], hasIndexedDB: false },
